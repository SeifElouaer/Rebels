                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-slate-700/50 rounded-lg p-4">
                        ...
                        <div className="flex flex-wrap gap-1">
                            {['Age', 'Income', 'Debt', 'Assets', 'Liabilities', 'Loan Amount', 'Tenure', 'Credit Score'].map(tag => (
                    ...
                    <div className="bg-slate-700/50 rounded-lg p-4">
                        <h4 className="font-medium text-cyan-400 mb-2">Time-Series Features</h4>
                        <div className="flex flex-wrap gap-1">
                            {['Delinquencies', 'Payment History', 'Utilization Trends'].map(tag => (
                                <span key={tag} className="feature-tag bg-cyan-500/20 text-cyan-300">{tag}</span>
                            ))}
                        </div>
                    </div>
                </div>
        ...
        "must": [
            ...
            {"key": "decision_date", "range": {"gte": "2021-01-01"}}
                ...
                <p className="text-sm text-slate-400">
                    Qdrant's HNSW-based approximate nearest neighbor index provides fast retrieval even with hundreds of thousands of cases. 
